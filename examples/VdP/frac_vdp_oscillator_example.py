...
n_calc = 3 * n_eval # A bit of a technicality: the order of the polynomial goes up by 3 since it gets multiplied 3 times in the VdP system equation. 
...
x_0 = np.array([2, 0])  # Initial value (x, y). 
...
forcing_params['A'] = 3         
forcing_params['omega'] = 5   
forcing_params['dim'] = 1       # Denotes the dimension the forcing gets applied to. In this case the "y" coordinate, hence 1
